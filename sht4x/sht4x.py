...
from sht4x.sht4x_configuration import SHT4XConfiguration
...
class SHT4X:
    ...
    **Quickstart: Importing and using the device**
    ...
    def __init__(self, address, i2c, configuration=SHT4XConfiguration()) -> None:
        self._i2c = i2c
    ...
    @property
    def configuration(self) -> SHT4XConfiguration:
        """Get configuration"""
        return self._configuration
    
    
    @configuration.setter
    def configuration(self, configuration: SHT4XConfiguration):
        """Set configuration
        """
        self._configuration = configuration
        self._temperature_precision = configuration.temperature_precision
        self._heater_power = configuration.heater_power
        self._heat_time = configuration.heater_timespan
